...
\begin{enumerate}[\hspace{9px} a)]
    ...
    \item \(f(x)=\displaystyle\frac{x+1}{x^2+1}\) sobre $\left[-1,\frac{1}{2}\right]$\bigskip
        ...
        Obtenemos $f'(x)$:
        \begin{align*}
            \displaystyle\frac{d}{dx}\frac{x+1}{x^2+1} &= \frac{\displaystyle \frac{d}{dx}(x+1) \cdot (x^2+1) - \frac{d}{dx}(x^2+1)\cdot(x+1)}{(x^2+1)^2} = \frac{(x^2+1)(1)-2x(x+1)}{(x^2+1)^2}\\
            &= \frac{x^2+1-2x^2-2x}{(x^2+1)^2} = \frac{-x^2+1-2x}{(x^2+1)^2}
        \end{align*}

        Ahora buscamos los puntos cr\'ticos:\medskip

        Observaci\'on: $(x^2+1)^2 \neq 0$

        \[\frac{-x^2+1-2x}{(x^2+1)^2}=0 \Rightarrow -x^2+1-2x=0\]

        Usando la f\'ormula cuadr\'atica tenemos:

        \(x=\displaystyle\frac{-b\pm \sqrt{b^2-4ac}}{2a}\) \quad con $a=-1$, $b=-2$ y $c=1$

        \begin{align*}
            x&=\frac{-(-2)\pm \sqrt{(-2)^2-4(-1)(1)}}{2(-1)} = \frac{2\pm \sqrt{4+4}}{-2} = -\frac{2\pm \sqrt{8}}{2}
        \end{align*}

        Como \(-\displaystyle\frac{2+\sqrt{8}}{2} \notin [-1,\frac{1}{2}]\), solo consideraremos \(-\displaystyle\frac{2-\sqrt{8}}{2} \approx 0.4\)\medskip

        Ahora obtenemos $f(x)$ para los puntos cr\'iticos y los extremos del intervalo:

        \(f(-1)=\displaystyle\frac{(-1)+1}{(-1)^2+1} = \frac{0}{2}=0\)

        \(f\left(\displaystyle\frac{1}{2}\right) = \displaystyle\frac{\left(\displaystyle\frac{1}{2}\right)+1}{\left(\displaystyle\frac{1}{2}\right)^2+1} = \frac{\displaystyle\frac{3}{2}}{\displaystyle\frac{5}{4}}= \frac{6}{5} = 1.2\)

        \(f(0.4)=\displaystyle\frac{x+1}{x^2+1} = \frac{(0.4)+1}{(0.4)^2+1} = \frac{0.4+1}{0.16+1} = \frac{1.4}{1.16} = 1.206\)\medskip

        Entonces: 
        \begin{center}
            \textbf{M\'aximo: } $\left(-\displaystyle\frac{2-\sqrt{8}}{2},1.206\right)$ \hspace{4em} \textbf{M\'inimo: } $(-1,0)$
        \end{center}\medskip
...
\begin{enumerate}[\hspace{9px} a)]
    ...
    \item Gr\'afica de la derivada de $f$.\medskip
        ...
        \includegraphics[width=0.5\textwidth]{ejer-c}\medskip
        ...
        En base a la observaci\'on tenemos que:
        \begin{itemize}
            \item 1 es un punto m\'inimo.
            \item 2 no es ni m\'inimo y m\'aximo.
            \item 3 es un punto m\'aximo.
            \item 4 no es ni un m\'inimo y m\'aximo.\bigskip
            \item $f$ es creciente en el intevalo: \((1,3)\)
            \item $f$ es decreciente en los intevalos: \((-\infty,1),(3,\infty)\)
        \end{itemize}\medskip
    ...
    \item Gr\'afica de la derivada de $f$.\medskip
        ...
        \includegraphics[width=0.5\textwidth]{ejer-d}\medskip
...
\begin{enumerate}[\hspace{9px} a)]
    \item \(f(x)=x+\displaystyle\frac{1}{x}\)\medskip
        ...
        Entonces, $f$ es convexa en $x>0$, porque la funci\'on es impar, $f$ es c\'oncava en $x<0$.

        \begin{figure}[ht]
            \centering
            \includegraphics[width=0.5\textwidth]{16-a}
            \caption{Bosquejo de la funci\'on a}
        \end{figure}

    \item \(f(x)=x+\displaystyle\frac{3}{x^2}\)\medskip
    
        Obtenemos el dominio y la imagen de la función.\medskip

        \textbf{Dom(f):} $\mathbbm{R}\setminus\{0\}$ porque \(\frac{3}{x^2} \Rightarrow x \neq 0 \)\medskip

        $f$ tiene una as\'intota vertical en x=0. \medskip

        \textbf{Im(f):}
        \[x+\displaystyle\frac{3}{x^2}=b \Rightarrow x^2(b-x)-3=0 \Rightarrow -x^3+bx^2-3=0\]
        ...
        \textbf{Continuidad:}
        \(x+\displaystyle\frac{3}{x^2}\) no es continua porque x no puede ser 0.\medskip

        \textbf{Paridad:}
        Para determinar si es par tenemos que evaluar $f(-x)$:

        \[f(-x)=-x+\displaystyle\frac{3}{(-x)^2}= -x+\frac{3}{x^2}\]
        
        $f(x)$ no es ni par, ni impar.\medskip
        ...
        \(\displaystyle\frac{18}{x^4} > 0\) \quad Como $18>0$ es una constante, para que $f''$ sea positiva, \(x^4>0 \Rightarrow x=\mathbbm{R}\)\medskip

        Entonces, $f$ es convexa en $x>0$. Como $x<0$ no tiene puntos cr\'iticos, no puede ser ni convexa ni c\'oncava.

        \begin{figure}[ht]
            \centering
            \includegraphics[width=0.5\textwidth]{16-b}
            \caption{Bosquejo de la funci\'on b}
        \end{figure}

    \item \(f(x)=\displaystyle\frac{x^2}{x^2-1}\)\medskip
    
        Obtenemos el dominio y la imagen de la función.\medskip

        \textbf{Dom(f):} $\mathbbm{R}\setminus\{1,-1\}$ porque \(\frac{x^2}{x^2-1} \Rightarrow x^2-1 \neq 0 \Rightarrow x^2 \neq 1\)\medskip

        $f$ tiene una as\'intota vertical en x=1 y otra en x=-1. \medskip

        \textbf{Im(f):}
        \begin{align*}
            \displaystyle\frac{x^2}{x^2-1}=&b \Rightarrow b(x^2-1)-x^2=0 \Rightarrow bx^2-b-x^2=0\\
            &x^2(b-1)-b=0 \Rightarrow x^2=\frac{b}{b-1} \Rightarrow b \neq 1
        \end{align*}
        ...
        \[\displaystyle\frac{2+6x^2}{(x^2-1)^3}>0
        \begin{cases*}
            2+6x^2>0 \wedge x^2-1>0 \Rightarrow x^2>-\frac{2}{6} \wedge x^2>1 \Rightarrow x\in\mathbbm{R} \wedge x>1 \vee x<-1\\
            2+6x^2<0 \wedge x^2-1<0 \Rightarrow x^2<-\frac{2}{6} \wedge x^2>1 \Rightarrow\!\Leftarrow
        \end{cases*}
        \]

        Para la negativa es an\'alogo: \(x>\frac{1}{3} \wedge x<-\frac{1}{3}\)

        $f$ es c\'oncava en \(-1<x<1\) y convexa en \(x>1 \vee x<-1\)

        \begin{figure}[ht]
            \centering
            \includegraphics[width=0.5\textwidth]{16-c}
            \caption{Bosquejo de la funci\'on c}
        \end{figure}

        NOTA: Lo lamento, se nos olvid\'o este bosquejo.

    \item \(f(x)=\displaystyle\frac{1}{x^2+1}\)\medskip
    
        Obtenemos el dominio y la imagen de la función.\medskip

        \textbf{Dom(f):} $\mathbbm{R}$ porque \(x^2+1\neq0\)\medskip

        \textbf{Im(f):}
        \[\displaystyle\frac{1}{x^2+1}=b \Rightarrow x^2+1=\frac{1}{b} \Rightarrow x=\sqrt{\frac{1}{b}-1}\]
