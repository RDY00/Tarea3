...
\begin{proof}
    ...
    \begin{equation}
        \label{5intab}
        L(f(ct),P)\leq\int_{a}^{b}f(ct)dt\leq U(f(ct),P)
    \end{equation}
    ...
    \begin{equation}
        \label{5intcacb}
        L(f,P')\leq\int_{ca}^{cb}f(t)dt\leq U(f,P')
    \end{equation}
    ...
    Multiplicamos \eqref{5intab} por $c$: \quad \(c\cdot L(f,P)\leq c\cdot\int_{a}^{b}f(ct)dt\leq c\cdot U(f,P)\).\bigskip
