...
\begin{enumerate}[\hspace{9px} a)]
    ...
    \item \(x^4 \text{, en} \ -4 \leq x \leq 4\)\medskip
        ...
        Al ser un polinomio $x^4$ es continua en cualquier intervalo e integrable.

        Como $f$ es integrable en \(x^4 \text{, en} \ -4\) entonces:  \[inf\{U(f,P)\}=\displaystyle\int_{4}^{4}x^4dx=sup\{L(f,P)\}\]

        Lo que hacemos es encontrar la primera cota Superior (M) y como \(4\in[-4,4]\) y como $(4)^4=256$ (que sería la $f(x)$ más grande en los positivos, pero como es par seria la misma en los negativos y en los positivos),podemos concluir que la cota $M(b-a)$ es $256(4-(-4))$. Ahora para la cota inferior, sabemos que el valor mínimo que puede obtener la función es $f(x)=0$ y como \(0\in[-4,4]\) entoces la cota $m(b-a)$ es $0(4-(-4))$.\medskip
    ...
    \item \(\tan(x) \text{, en} \ -\displaystyle\frac{\pi}{4} \leq x \leq \frac{\pi}{4}\) \medskip
        ...
        Sabemos que $tan(x)$ es continua en cualquier intervalo y su periodo es $\pi$.También que es integrable.Ademas sabemos que es creciente. \medskip
        Como el intervalo no es $[-\pi,\pi]$,(ya que se haría infinito y no se podría encontrar la cota)entonces es integrable en el intervalo \([-\frac{\pi}{4},\frac{\pi}{4}]\).

        Como $\tan(x)$ es integrable en \([-\frac{\pi}{4},\frac{\pi}{4}]\), se tiene:
        \[sup\{L(f,P)\}=\displaystyle\int_{-\frac{\pi}{4}}^{\frac{\pi}{4}}\tan(x)dx=inf\{U(f,P)\}\]\medskip

        Para la cota superior debemos encontrar la $f(x)$ más grande en ese intervalo, como $\frac{\pi}{4}\in[-\frac{\pi}{4},\frac{\pi}{4}]$ y \(tan(\frac{\pi}{4})=1\)(que es el valor máximo),la cota superior $M(b-a)$ será $1(\frac{\pi}{4}-(-\frac{\pi}{4}))$.
        Ahora para la cota inferior o m,como $tan(x)$ es impar, se tiene que $-\frac{\pi}{4}\in[-\frac{\pi}{4},\frac{\pi}{4}]$ entonces,\(tan(-\frac{\pi}{4})=-1\) (el valor más pequeño para f(x)), por lo anterior se tiene que la cota $m(b-a)$ es $-1(\frac{\pi}{4}-(-\frac{\pi}{4}))$.\medskip
