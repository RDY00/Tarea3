...
\begin{enumerate}[\hspace{9px} a)]
    ...
    \item \(f(x)=\tan(x)-x\)\bigskip
        ...
        \textbf{Dominio: }\medskip
            ...
            Como no hay ing\'un punto donde la funci\'on est\'e indefinida: \(Dom(f):\mathbbm{R}\setminus\displaystyle\left\{\frac{(2k+1)\pi}{2}, k\in\mathbbm{Z}\right\}\)\bigskip
...
\begin{enumerate}[\hspace{9px} a)]
    ...
    \item \(f(x)=e^{1+x}\)\bigskip
        ...
        \textbf{Dominio: }\medskip
            ...
            NOTA: \(f(0)=e^{1+0}=e\), lo que signica que la funci\'on se inteseca con el eje de las $y$ en \((0,e)\)\medskip
    ...
    \item \(f(x)=e^{\sin(x)}\)
        ...
        \textbf{Raices: }\medskip
            ...
            Como \(\frac{1}{e}>0\), $f(x)$ nunca es 0.\medskip
        ...
        \textbf{Puntos y valores cr\'iticos: }
            ...
            Al final usamos el periodo de seno (\(2\pi\)) y su paridad para encontrar todos los valores cr\'iticos.\medskip
